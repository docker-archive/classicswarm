...
func NewPopulatedCommandInfo(r randyMesos, easy bool) *CommandInfo {
	...
	if r.Intn(10) != 0 {
		v28 := r.Intn(10)
		this.Arguments = make([]string, v28)
		for i := 0; i < v28; i++ {
...
func NewPopulatedExecutorInfo(r randyMesos, easy bool) *ExecutorInfo {
	...
	if r.Intn(10) != 0 {
		v36 := r.Intn(10)
		this.Resources = make([]*Resource, v36)
		for i := 0; i < v36; i++ {
...
func NewPopulatedSlaveInfo(r randyMesos, easy bool) *SlaveInfo {
	...
	if r.Intn(10) != 0 {
		v48 := r.Intn(10)
		this.Resources = make([]*Resource, v48)
		for i := 0; i < v48; i++ {
			this.Resources[i] = NewPopulatedResource(r, easy)
		}
	}
	if r.Intn(10) != 0 {
		v49 := r.Intn(10)
		this.Attributes = make([]*Attribute, v49)
		for i := 0; i < v49; i++ {
...
func NewPopulatedResourceStatistics(r randyMesos, easy bool) *ResourceStatistics {
	...
	if r.Intn(10) != 0 {
		...
		this.CpusSystemTimeSecs = &v79
	}
	if r.Intn(10) != 0 {
		v80 := float64(r.Float64())
		if r.Intn(2) == 0 {
			v80 *= -1
		}
		this.CpusLimit = &v80
	...
	if r.Intn(10) != 0 {
		...
		this.MemTotalBytes = &v84
	}
	if r.Intn(10) != 0 {
		v85 := uint64(uint64(r.Uint32()))
		this.MemTotalMemswBytes = &v85
	}
	if r.Intn(10) != 0 {
		v86 := uint64(uint64(r.Uint32()))
		this.MemLimitBytes = &v86
	}
	if r.Intn(10) != 0 {
		v87 := uint64(uint64(r.Uint32()))
		this.MemSoftLimitBytes = &v87
	}
	if r.Intn(10) != 0 {
		v88 := uint64(uint64(r.Uint32()))
		this.MemFileBytes = &v88
	}
	if r.Intn(10) != 0 {
		v89 := uint64(uint64(r.Uint32()))
		this.MemAnonBytes = &v89
	}
	if r.Intn(10) != 0 {
		v90 := uint64(uint64(r.Uint32()))
		this.MemCacheBytes = &v90
	}
	if r.Intn(10) != 0 {
	...
	if r.Intn(10) != 0 {
		...
		this.MemMappedFileBytes = &v92
	}
	if r.Intn(10) != 0 {
		v93 := uint64(uint64(r.Uint32()))
		this.MemSwapBytes = &v93
	}
	if r.Intn(10) != 0 {
	...
	if r.Intn(10) != 0 {
		...
		this.DiskLimitBytes = &v97
	}
	if r.Intn(10) != 0 {
		v98 := uint64(uint64(r.Uint32()))
		this.DiskUsedBytes = &v98
	}
	if r.Intn(10) != 0 {
	...
	if r.Intn(10) != 0 {
		v111 := float64(r.Float64())
		if r.Intn(2) == 0 {
			v111 *= -1
		}
		this.NetTcpActiveConnections = &v111
	}
	if r.Intn(10) != 0 {
		...
		this.NetTcpTimeWaitConnections = &v112
	}
	if r.Intn(10) != 0 {
		v113 := r.Intn(10)
		this.NetTrafficControlStatistics = make([]*TrafficControlStatistics, v113)
		for i := 0; i < v113; i++ {
...
func NewPopulatedOffer(r randyMesos, easy bool) *Offer {
	...
	if r.Intn(10) != 0 {
		v172 := r.Intn(10)
		this.Attributes = make([]*Attribute, v172)
		for i := 0; i < v172; i++ {
			this.Attributes[i] = NewPopulatedAttribute(r, easy)
		}
	}
	if r.Intn(10) != 0 {
		v173 := r.Intn(10)
		this.ExecutorIds = make([]*ExecutorID, v173)
		for i := 0; i < v173; i++ {
...
func NewPopulatedTaskStatus(r randyMesos, easy bool) *TaskStatus {
	...
	if r.Intn(10) != 0 {
		v189 := r.Intn(100)
		this.Uuid = make([]byte, v189)
		for i := 0; i < v189; i++ {
			this.Uuid[i] = byte(r.Intn(256))
		}
	}
	if r.Intn(10) != 0 {
		v190 := bool(bool(r.Intn(2) == 0))
		this.Healthy = &v190
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedMesos(r, 12)
...
func (m *FrameworkInfo_Capability) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Resource_ReservationInfo) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Resource_RevocableInfo) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TrafficControlStatistics) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ResourceUsage_Executor) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (this *FrameworkInfo_Capability) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.FrameworkInfo_Capability{` +
		`Type:` + valueToGoStringMesos(this.Type, "mesosproto.FrameworkInfo_Capability_Type"),
		`XXX_unrecognized:` + fmt.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
...
func (this *CommandInfo_URI) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.CommandInfo_URI{` +
		...
		`Cache:` + valueToGoStringMesos(this.Cache, "bool"),
		`XXX_unrecognized:` + fmt.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
...
func (this *Resource) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.Resource{` +
		...
		`Revocable:` + fmt.Sprintf("%#v", this.Revocable),
		`XXX_unrecognized:` + fmt.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Resource_ReservationInfo) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.Resource_ReservationInfo{` +
		`Principal:` + valueToGoStringMesos(this.Principal, "string"),
		`XXX_unrecognized:` + fmt.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
...
func (this *Resource_RevocableInfo) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.Resource_RevocableInfo{` +
		`XXX_unrecognized:` + fmt.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *TrafficControlStatistics) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.TrafficControlStatistics{` +
		`Id:` + valueToGoStringMesos(this.Id, "string"),
		`Backlog:` + valueToGoStringMesos(this.Backlog, "uint64"),
		`Bytes:` + valueToGoStringMesos(this.Bytes, "uint64"),
		`Drops:` + valueToGoStringMesos(this.Drops, "uint64"),
		`Overlimits:` + valueToGoStringMesos(this.Overlimits, "uint64"),
		`Packets:` + valueToGoStringMesos(this.Packets, "uint64"),
		`Qlen:` + valueToGoStringMesos(this.Qlen, "uint64"),
		`Ratebps:` + valueToGoStringMesos(this.Ratebps, "uint64"),
		`Ratepps:` + valueToGoStringMesos(this.Ratepps, "uint64"),
		`Requeues:` + valueToGoStringMesos(this.Requeues, "uint64"),
		`XXX_unrecognized:` + fmt.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *ResourceStatistics) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.ResourceStatistics{` +
		...
		`Processes:` + valueToGoStringMesos(this.Processes, "uint32"),
		`Threads:` + valueToGoStringMesos(this.Threads, "uint32"),
		`MemLowPressureCounter:` + valueToGoStringMesos(this.MemLowPressureCounter, "uint64"),
		`MemMediumPressureCounter:` + valueToGoStringMesos(this.MemMediumPressureCounter, "uint64"),
		`MemCriticalPressureCounter:` + valueToGoStringMesos(this.MemCriticalPressureCounter, "uint64"),
		`NetTrafficControlStatistics:` + fmt.Sprintf("%#v", this.NetTrafficControlStatistics),
		`MemTotalBytes:` + valueToGoStringMesos(this.MemTotalBytes, "uint64"),
		`MemTotalMemswBytes:` + valueToGoStringMesos(this.MemTotalMemswBytes, "uint64"),
		`MemSoftLimitBytes:` + valueToGoStringMesos(this.MemSoftLimitBytes, "uint64"),
		`MemCacheBytes:` + valueToGoStringMesos(this.MemCacheBytes, "uint64"),
		`MemSwapBytes:` + valueToGoStringMesos(this.MemSwapBytes, "uint64"),
		`XXX_unrecognized:` + fmt.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
...
func (this *ResourceUsage_Executor) GoString() string {
	...
	s := strings.Join([]string{`&mesosproto.ResourceUsage_Executor{` +

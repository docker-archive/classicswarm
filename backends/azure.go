...
func parseUserSpecifiedOptions(args []string, options *AzureConfig) {
	...
	for _, value := range args {
		...
		case "--azure_subscription_cert":
			options.SubscriptionCert = val
		case "--azure_publish_settings_file":

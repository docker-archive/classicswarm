...
//type DefaultNamesImpl struct{}
//
//func (authN DefaultNamesImpl) Scope(cluster cluster.Cluster, eventType states.EventEnum, w http.ResponseWriter, r *http.Request, next http.Handler) error {

...
var routes = map[string]map[string]handler{
	...
	"POST": {
		...
		// TODO: is the right thing? Looks like a container, not and engine nor node.
		"/containers/{name:.*}/setmaintenance": postContainerSetMaintenance,
		"/containers/{name:.*}/getmaintenance": postContainerGetMaintenance,

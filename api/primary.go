...
var routes = map[string]map[string]handler{
	...
	"GET": {
		...
		"/engines/{name:.*}/maintenance":  getEngineMaintenance,
		"/engines/{name:.*}/state":        getEngineState,
	...
	"POST": {
		...
		"/engines/{name:.*}/maintenance/start": postEngineMaintenanceStart,
		"/engines/{name:.*}/maintenance/stop":  postEngineMaintenanceStop,
